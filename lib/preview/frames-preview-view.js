...
var FramesPreviewView = function(arg)
{
	...
	console.log('FRAMES: FramesPreviewView', arg);
		...
		else
		{
			if (atom.workspace)
			{
				...
				if (pane)
				{
					...
					//pane.destroyItem(that); throws an error ???
				}
			}
		}
	};
...
{
	console.log('FRAMES: FramesPreviewView::renderXML()');
...
{
	console.log('FRAMES: FramesPreviewView::getHTML()');
...
{
	console.log('FRAMES: FramesPreviewView::renderXMLText()');
...
{
	return this.editor ? this.editor.getGrammar() : undefined;
};
