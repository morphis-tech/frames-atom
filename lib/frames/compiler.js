			...
			Config.load(cfgpath, function(err, cfg)
			{
				...
				Service.start(function(err)
				{
					...
					Service.addWebApp(webprojectrootpath, function(err, ctx)
					{
						...
						if (!ctx.viewroot)
						{
							// TODO sometimes service return context with no viewroot at the first time!! Return is causing theretry.
							// Check service to see what is happening, isn't suppose to not return the viewroot
							return;
						}
